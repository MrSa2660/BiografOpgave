...
- Payments: integrate provider (e.g., Stripe/PayPal) with checkout session and webhook handlers; mark bookings paid/failed and release seats on failure/expiry.
- Reviews/Ratings: endpoints to add/edit/delete reviews with auth/ownership; compute averages for display.
...
- Movies: list/search/filter/sort (now/soon); movie detail with trailer, cast, ratings, reviews.
...
- Reviews: add/edit/delete reviews; show averages and moderation cues.
